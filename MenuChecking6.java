...
public class MenuChecking6 
{
	...
	public void MenuChecking() 
	{
        ...
        //Checking if the "Activities menu item exista and is clickable
        WebElement activities_tab=driver.findElement(By.xpath("//*[@id='grouptab_3'"));
